...
# Suporta: help, discover, call, status, test, deploy, logs, auth, check_env, install_deps, setup_mode, install
# ==============================================================================
[CmdletBinding()]
param(
    [Parameter(Position = 0)]
    [ValidateSet("help", "discover", "call", "invoke", "status", "test", "deploy", "logs", "auth", "check_env", "diagnose", "install_deps", "setup_mode", "install", "onboard")]
    [string]$Action = "help",
...
function Show-Help() {
    ...
    Write-Host "     Sonda silenciosamente o ambiente e retorna JSON de gaps (Python, venv, pacotes, wrangler, cloudflared)." -ForegroundColor Gray
    Write-Host "     Exemplo: powershell -File control.ps1 -Action check_env -JsonOutput" -ForegroundColor Green
    Write-Host ""
    Write-Host "  3. install_deps" -ForegroundColor White
    ...
    Write-Host ""
    Write-Host "  4. setup_mode" -ForegroundColor White
    ...
    Write-Host ""
    Write-Host "  5. discover" -ForegroundColor White
    ...
    Write-Host ""
    Write-Host "  6. call (ou invoke)" -ForegroundColor White
    ...
    Write-Host ""
    Write-Host "  8. test" -ForegroundColor White
